...
@Repository
public class BasicFinderDaoImpl extends CustomHibernateDaoSupport implements BasicFinderDao
{
    ...
    {
        return (T) ensureUniqureResult(findByNamedParam(queryString, paramNames, values));
    }
    ...
    {
        return (T) ensureUniqureResult(findByNamedParam(queryString, paramName, value));
    }
    ...
    {
        return (T) ensureUniqureResult(findByNamedQueryAndNamedParam(queryName, paramNames, values));
    }
    ...
    {
        return (T) ensureUniqureResult(findByNamedQueryAndNamedParam(queryName, paramName, value));
    }
    ...
    {
        return (T) ensureUniqureResult(findByNamedQueryAndValueBean(queryName, valueBean));
    }
    ...
    protected <T> T ensureUniqureResult(List<T> findedResults)
    {
        ...
        {
            throw new IncorrectResultSizeDataAccessException(1, findedResults.size());
        }
    }
}

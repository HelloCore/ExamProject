...
<link rel="stylesheet" href="${contextPath}/css/management/question/add.css">
<div>
	...
	<div class="pagging-menu" id="menuHeader">
		<label for="courseId">วิชา&nbsp;:&nbsp;</label><select id="courseId" name="courseId"></select>
		<label for="questionGroupId">กลุ่มคำถาม&nbsp;:&nbsp;</label><select id="questionGroupId" name="questionGroupId"></select>
	...
	<div class="footer-panel">
		...
		<button id="createQuestionButton" class="btn btn-primary" >เพิ่มข้อสอบ</button>
	</div>
</div>
...
<div class="modal hide fade" id="confirmModal">
  ...
  <div class="modal-footer">
    ...
    <a href="#" class="btn btn-primary" id="confirmButton" data-loading-text="กำลังเพิ่ม...">Confirm</a>
  </div>
</div>
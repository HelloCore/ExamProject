						...
						<div class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls" id="examHeaderControls">
									...
									<button class="btn btn-info normal-header-button" id="editExamHeaderButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									<div class="wrapper edit-header-button" id="editExamHeaderButtonGroup" style="display:none;">
										<button class="btn btn-primary" id="saveExamHeaderButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
										<button class="btn " id="cancelExamHeaderButton"> ยกเลิก</button>
									</div>
								</div>
							</div>
							<div class="control-group" id="startDateGroup">
								...
								<div class="controls" id="examStartDateControls">
									<div class="normal-start-date-button edit-start-date">
										...
										<button class="btn btn-info" id="editStartDateButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									</div>
									<div class="edit-start-date-button edit-start-date hide">
					        			...
					        			<div class="wrapper" id="editStartDateButtonGroup">
											<button class="btn btn-primary save-start-date-button" id="saveStartDateButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
											<button class="btn" id="cancelStartDateButton"> ยกเลิก</button>
										</div>
									</div>
							    </div>
							</div>
							<div class="control-group" id="endDateGroup">
								...
								<div class="controls" id="examEndDateControls">
									<div class="normal-end-date-button edit-end-date">
										...
										<button class="btn btn-info " id="editEndDateButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									</div>
									<div class="edit-end-date-button edit-end-date hide">
					        			...
					        			<div class="wrapper" id="editEndDateButtonGroup">
											<button class="btn btn-primary save-end-date-button" id="saveEndDateButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
											<button class="btn" id="cancelEndDateButton"> ยกเลิก</button>
										</div>
									</div>
							    </div>
							</div>
							<div class="control-group" id="numOfQuestionGroup">
								...
								<div class="controls" id="numOfQuestionControls">
									<div class="normal-num-of-question-button edit-num-of-question">
										...
										<button class="btn btn-info " id="editNumOfQuestionButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									</div>
									<div class="edit-num-of-question-button edit-num-of-question hide">
										...
										<div class="wrapper" id="editNumOfQuestionButtonGroup">
											<button class="btn btn-primary save-num-of-question-button" id="saveNumOfQuestionButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
											<button class="btn" id="cancelNumOfQuestionButton"> ยกเลิก</button>
										</div>
									</div>
							    </div>
							</div>
							<div class="control-group" id="examLimitGroup">
								...
								<div class="controls">
									...
									<button class="btn btn-info normal-exam-limit-button" id="editExamLimitButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									<div class="wrapper edit-exam-limit-button" id="editExamLimitButtonGroup" style="display:none;">
										<button class="btn btn-primary save-exam-limit-button" id="saveExamLimitButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
										<button class="btn" id="cancelExamLimitButton"> ยกเลิก</button>
									</div>
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls normal-exam-sequence-button" >
									...
									<button class="btn btn-info" id="editExamSequenceButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
								</div>
								<div class="controls edit-exam-sequence-button" style="display:none;" >
									...
									<div class="wrapper" id="editExamSequenceButtonGroup">
										<button class="btn btn-primary save-exam-sequence-button" id="saveExamSequenceButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
										<button class="btn" id="cancelExamSequenceButton"> ยกเลิก</button>
									</div>
							    </div>
							</div>
						</div>
							...
							<tfoot>
								<tr class="normal-panel" id="normal-question-group-panel">
									<td colspan="4" class="center-row">
										<button class="btn btn-info" id="editQuestionGroupButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									</td>
								</tr>
								<tr class="edit-panel" id="edit-question-group-panel"> 
									<td colspan="5" class="center-row">
										<button class="btn btn-info" id="addQuestionGroupButton"><i class="icon-plus icon-white"></i> เพิ่ม</button>
										<button class="btn btn-primary" id="saveEditQuestionGroupButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
										<button class="btn" id="cancelEditQuestionGroupButton">ยกเลิก</button>
										<div class="wrapper">
						...
						<table class="table table-striped editable-section">
							...
							<tfoot>
								<tr class="normal-panel" id="normal-section-panel">
									<td colspan="4" class="center-row" >
										<button class="btn btn-info" id="editSectionButton"><i class="icon-edit icon-white"></i> แก้ไข</button>
									</td>
								</tr>
								<tr class="edit-panel" id="edit-section-panel"> 
									<td colspan="5" class="center-row">
										<button class="btn btn-info" id="addSectionButton"><i class="icon-plus icon-white"></i> เพิ่ม</button>
										<button class="btn btn-primary" id="saveEditSectionButton"><i class="icon-pencil icon-white"></i> บันทึก</button>
										<button class="btn" id="cancelEditSectionButton">ยกเลิก</button>
									</td>
								</tr>
							</tfoot>
						</table>
...
<div class="modal hide fade" id="questionGroupModal" tabindex="-1" >
  ...
  <div class="modal-footer">
    ...
    <a href="#" class="btn btn-info" id="addQuestionGroupConfirmButton" ><i class="icon-plus icon-white"></i> เพิ่ม </a>
  </div>
</div>
...
<div class="modal hide fade" id="sectionModal" tabindex="-1" >
    ...
    <form class="form-horizontal" id="searchSectionForm">	
    	<div class="control-group">
	     	<label class="control-label" for="sectionId">Section</label>
	      	<div class="controls">
	        	<select id="sectionId" class="input-medium" data-placeholder="กรุณาเลือก Section..." name="sectionId"></select>
	        </div>
	    </div>
	  </form>
  </div>
  <div class="modal-footer">
    <a href="#" class="btn" data-dismiss="modal">ปิด</a>
    <a href="#" class="btn btn-info" id="addSectionConfirmButton" ><i class="icon-plus icon-white"></i> เพิ่ม</a>
  </div>
</div>
...
<div class="modal hide fade" id="confirmGenericModal">
  ...
  <div class="modal-footer">
    <a href="#" class="btn" data-dismiss="modal">ปิด</a>
    <a href="#" class="btn btn-primary" id="confirmGenericButton" data-loading-text="กำลังแก้ไข..."><i class="icon-pencil icon-white"></i> แก้ไข</a>
  </div>
</div>
...
<div class="modal hide fade" id="confirmQuestionGroupModal">
  ...
  <div class="modal-footer">
    <a href="#" class="btn" data-dismiss="modal">ปิด</a>
    <a href="#" class="btn btn-primary" id="confirmQuestionGroupButton" data-loading-text="กำลังแก้ไข..."><i class="icon-pencil icon-white"></i> แก้ไข</a>
  </div>
</div>
...
<div class="modal hide fade" id="confirmSectionModal">
  ...
  <div class="modal-body">
    <p>ต้องการแก้ไข Section ที่มีสิทธิ์สอบใช่หรือไม่ โปรดยืนยัน</p>
  </div>
  <div class="modal-footer">
    <a href="#" class="btn" data-dismiss="modal">ปิด</a>
    <a href="#" class="btn btn-primary" id="confirmSectionButton" data-loading-text="กำลังแก้ไข..."><i class="icon-pencil icon-white"></i> แก้ไข</a>
  </div>
</div>

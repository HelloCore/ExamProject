...
<%-- <script type="text/javascript" src="${contextPath}/resources/json2.js"></script>
...
<script src="${contextPath}/resources/jquery.scrollTo-min.js"></script>
<script src="${contextPath}/resources/jquery.countdown.min.js"></script>
<script src="${contextPath}/scripts/exam/doExam.js"></script>